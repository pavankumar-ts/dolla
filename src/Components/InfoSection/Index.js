...
import img from '../../Image/svg-1.svg'

export const InfoSection = ({lightBg,id,imgStart,topLine,lightText,headLine,
    darkText,discription,buttonLabel,img,alt,primary,dark,dark2}) => {
    return (
        <>
